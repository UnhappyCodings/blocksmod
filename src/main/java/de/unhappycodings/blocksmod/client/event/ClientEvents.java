...
public class ClientEvents {
    ...
    public static void onStartupEvent(FMLClientSetupEvent event) {
        ...
        ItemBlockRenderTypes.setRenderLayer(ModBlocks.ANORTHOSITE_BIG_SLIDING_DOOR.get(), RenderType.translucent());
    ...
    public static void onRegisterRenderers(final EntityRenderersEvent.RegisterRenderers event) {
        event.registerBlockEntityRenderer(ModBlockEntities.ANORTHOSITE_BIG_SLIDING_DOOR.get(), BigSlidingDoorRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.LIMESTONE_BIG_SLIDING_DOOR.get(), BigSlidingDoorRenderer::new);
    }
